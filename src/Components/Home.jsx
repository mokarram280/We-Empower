...
function Home() {
  return (
    <section style={{backgroundImage:`url(${img})`}} className='bg-no-repeat bg-cover'>
        <div className='text-center py-20 px-12 space-y-8 w-full'>
            ...
            <button className='bg-white px-5 py-2 font-semibold rounded-full text-[#F44335] text-sm'>Ask questions</button>
        </div>
        <div>
